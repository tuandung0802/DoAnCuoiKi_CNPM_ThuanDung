...
?>
<title>Tạo hóa đơn xuất</title>
		...
		<div class="load-animate animated fadeInUp">
			<div class="row">
				<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
					<h2 class="title">Tạo hóa đơn xuất</h2>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-right">
					...
					<div class="form-group">
						<input type="text" class="form-control"required name="companyName" id="companyName" placeholder="Tên đại lý" autocomplete="off">
					</div>
					<div class="form-group">
