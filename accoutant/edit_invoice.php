		    	...
		    	<div class="row">
		      		...
		      		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-right">
		      			...
		      			<div class="form-group">
							<input value="<?php echo $invoiceValues['order_receiver_name']; ?>" required type="text" class="form-control" name="companyName" id="companyName" placeholder="Tên công ty" autocomplete="off">
						</div>
						<div class="form-group">
							<textarea class="form-control" required rows="3" name="address" id="address" placeholder="Your Address"><?php echo $invoiceValues['order_receiver_address']; ?></textarea>
						</div>
