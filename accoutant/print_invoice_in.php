...
if(!empty($_GET['invoice_id']) && $_GET['invoice_id']) {
	...
	$invoiceValues = $invoice->getInvoice_in($_GET['invoice_id']);		
	$invoiceItems = $invoice->getInvoiceItems_in($_GET['invoice_id']);		
}
$invoiceDate = date("d/M/Y, H:i:s", strtotime($invoiceValues['order_date']));
$output = '';
$output .= '<table width="100%" border="1" cellpadding="5" cellspacing="0">
	<tr>
	<td colspan="2" align="center" style="font-size:18px"><b>Input Invoice</b></td>
	</tr>
	<tr>
	<td colspan="2">
	...
	Name : '.$invoiceValues['order_import_name'].'<br /> 
	Billing Address : '.$invoiceValues['order_import_address'].'<br />
	</td>
	<td width="35%">         
...
$output .= '
	...
	<tr>
	<td align="right" colspan="5">VAT Amount: </td>
	...
	<td align="left">'.$invoiceValues['order_total_amount_due'].'   (VND)</td> 
	</tr>';
$output .= '
	</table>
	</td>
