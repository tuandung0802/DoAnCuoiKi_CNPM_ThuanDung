...
if(!empty($_POST['companyName']) && $_POST['companyName'] && !empty($_POST['invoiceId']) && $_POST['invoiceId']) {	
	$invoice->updateInvoice_in($_POST);	
	header("Location:invoice_list_in.php");	
}
if(!empty($_GET['update_id']) && $_GET['update_id']) {
	$invoiceValues = $invoice->getInvoice_in($_GET['update_id']);		
	$invoiceItems = $invoice->getInvoiceItems_in($_GET['update_id']);		
}
?>
	    	...
	    	<div class="load-animate animated fadeInUp">
		    	<div class="row">
		    		<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
		    			<h1 class="title">Chỉnh sửa hóa đơn</h1>
		    	...
		    	<div class="row">
		      		...
		      		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-right">
		      			...
		      			<div class="form-group">
							<input value="<?php echo $invoiceValues['order_import_name']; ?>" required type="text" class="form-control" name="companyName" id="companyName" placeholder="Tên công ty" autocomplete="off">
						</div>
						<div class="form-group">
							<textarea class="form-control" required rows="3" name="address" id="address" placeholder="Your Address"><?php echo $invoiceValues['order_import_address']; ?></textarea>
						</div>
		      		...
		      		<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
						...
						<div class="form-group">
							...
							<input type="hidden" value="<?php echo $invoiceValues['order_id']; ?>" class="form-control" name="invoiceId" id="invoiceId">
			      			<input data-loading-text="Updating Invoice..." type="submit" name="invoice_btn" value="Lưu hóa đơn" class="btn btn-success submit_btn invoice-save-btm">
			      		</div>
